<template>
    <div>
        <h1 class="text-2xl font-bold text-black dark:text-white md:text-6xl">Featured Posts</h1>
        ...
        <a class="flex h-6 items-center rounded-lg md:text-2xl transition-all hover:underline hover:decoration-orange-500 hover:decoration-4"
            href="/blog">Read all posts<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                class="ml-1 h-6 w-6">
